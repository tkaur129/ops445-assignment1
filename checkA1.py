...
Description: Test cases for the date manipulation and validation program
'''

import os
import unittest
from assignment1 import day_of_week, leap_year, mon_max, after, before, valid_date, day_iter
...
class TestValidDate(unittest.TestCase):
    ...
    def test_valid_dates(self):
        ...
        self.assertTrue(valid_date("29/02/2024"))  # Leap year

    def test_invalid_dates(self):
        self.assertFalse(valid_date("00/01/2024"))
        self.assertFalse(valid_date("31/02/2024"))
        self.assertFalse(valid_date("32/01/2024"))
